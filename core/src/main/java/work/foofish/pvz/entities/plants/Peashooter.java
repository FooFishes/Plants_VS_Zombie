...
public class Peashooter extends BasePlant {
    ...
    public Peashooter (GameScreen screen, float x, float y, int row, int col) {
    ...
    private static Animation<TextureRegion> createAnimation (GameScreen screen) {
        ...
        return new Animation<>(0.1f, atlas.findRegions(AssetPaths.REGION_PEASHOOTER), Animation.PlayMode.LOOP);
    }
    ...
    private void fire () {
        float bulletX = position.x + bounds.width - 10f;
